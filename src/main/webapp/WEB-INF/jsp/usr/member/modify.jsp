		...
		<form class="table-box-type-1" method="POST"
			...
			<table class="table table-zebra w-full">
				...
				<tbody>
					...
					<tr>
						<th>이름</th>
						<td><input value="${rq.loginedMember.name }" name="name"
							class="w-full input input-bordered  max-w-xs"
							placeholder="이름을 입력해주세요" /></td>
					</tr>
					<tr>
						<th>닉네임</th>
						<td><input value="${rq.loginedMember.nickname }"
							name="nickname" class="w-full input input-bordered  max-w-xs"
							placeholder="닉네임을 입력해주세요" /></td>
					</tr>
					<tr>
						<th>전화번호</th>
						<td><input value="${rq.loginedMember.cellphoneNum }"
							name="cellphoneNum" class="w-full input input-bordered  max-w-xs"
							placeholder="전화번호를 입력해주세요" /></td>
					</tr>
					<tr>
						<th>이메일</th>
						<td><input value="${rq.loginedMember.email }" name="email"
							class="w-full input input-bordered  max-w-xs"
